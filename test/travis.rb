...
result, status = Open3.capture2e "sass main.scss build/main.css"
...
result, status = Open3.capture2e "sass test/silent.scss build/silent.css --style compressed"
raise result unless status.success?
...
stdout, stderr, status = Open3.capture3 "sass test/undefined-colors-warn.scss build/undefined-colors-warn.css --style compressed"
